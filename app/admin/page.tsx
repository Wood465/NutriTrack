      ...
      <div className="mx-auto w-full max-w-7xl px-6 pb-16 pt-12">
        ...
        <section className="mt-10 rounded-3xl border border-white/70 dark:border-slate-800 bg-white dark:bg-slate-900/90 dark:bg-slate-900/80 p-6 shadow-xl shadow-slate-200/70 dark:shadow-black/30 backdrop-blur">
          <div className="mb-4 flex items-center justify-between">
            ...
            <span className="rounded-full border border-slate-200 dark:border-slate-700 bg-slate-100 dark:bg-slate-800/60 px-3 py-1 text-xs font-medium text-slate-600 dark:text-slate-300">
              {users.length} skupaj
            </span>
          </div>
          ...
          <div className="overflow-x-auto rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900">
            <table className="min-w-full text-sm">
              <thead className="bg-slate-100 dark:bg-slate-800/60 text-left text-slate-600 dark:text-slate-300">
                <tr>
              ...
              <tbody>
                {users.map((u) => (
                  <tr key={u.id} className="border-t border-slate-200 dark:border-slate-700">
                    ...
                    <td className="px-4 py-3">
                      <span className="rounded-full border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900/60 px-3 py-1 text-xs font-medium text-slate-600 dark:text-slate-300">
                        {u.role}
                      </span>
                    </td>
                    <td className="px-4 py-3">
                ...
                {users.length === 0 && (
                  <tr>
                    <td colSpan={3} className="px-4 py-6 text-slate-500 dark:text-slate-300">
