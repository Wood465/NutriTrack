const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/page-BrrH_kvM.js","assets/navbar-DzC7B8O3.js","assets/page-wM-SHp5i.js","assets/page-BLQ0DgpF.js","assets/page-9T7i3YCN.js"])))=>i.map(i=>d[i]);
...
const C__Users_jakob_Desktop_NutriTrack_tests_components___app_login_page = () => __vitePreload(() => import('./page-BrrH_kvM.js'),true              ?__vite__mapDeps([0,1]):void 0).then((mod) => mod.default);
const C__Users_jakob_Desktop_NutriTrack_tests_components___app_meals_page = () => __vitePreload(() => import('./page-wM-SHp5i.js'),true              ?__vite__mapDeps([2,1]):void 0).then((mod) => mod.default);
const C__Users_jakob_Desktop_NutriTrack_tests_components___app_ui_navbar = () => __vitePreload(() => import('./navbar-DzC7B8O3.js').then(n => n.n),true              ?[]:void 0).then((mod) => mod.default);
const C__Users_jakob_Desktop_NutriTrack_tests_components___app_profile_page = () => __vitePreload(() => import('./page-BLQ0DgpF.js'),true              ?__vite__mapDeps([3,1]):void 0).then((mod) => mod.default);
const C__Users_jakob_Desktop_NutriTrack_tests_components___app_register_page = () => __vitePreload(() => import('./page-9T7i3YCN.js'),true              ?__vite__mapDeps([4,1]):void 0).then((mod) => mod.default);
...
//# sourceMappingURL=index-BjA8hei5.js.map
