import { j as jsxRuntimeExports, N as Navbar, f as fetchWithTimeout } from './navbar-DzC7B8O3.js';
import { r as reactExports } from './index-BjA8hei5.js';
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-6xl space-y-10 px-4 pb-16 pt-10 md:px-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "grid gap-6 lg:grid-cols-[1.1fr_1.4fr]", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-3xl border border-gray-200/70 bg-white/95 p-6 shadow-sm backdrop-blur dark:border-gray-800/70 dark:bg-gray-900/80 md:p-8", children: [
          ...
          meals.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 rounded-2xl border border-dashed border-gray-200 p-6 text-sm text-gray-500 dark:border-gray-800 dark:text-gray-400", children: "Se ni dodanih obrokov. Dodaj prvega in zacni spremljati vnos." }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "mt-6 space-y-4", children: meals.slice(
              (currentPage - 1) * mealsPerPage,
              currentPage * mealsPerPage
            ).map((meal, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "li",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 flex flex-wrap items-center justify-between gap-3 text-sm text-gray-600 dark:text-gray-300", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    disabled: currentPage === Math.max(1, Math.ceil(meals.length / mealsPerPage)),
...
//# sourceMappingURL=page-wM-SHp5i.js.map
